/**
 * The pure half of lib/scheduling.ts — gaps, travel, phrasing, collisions.
 *
 * Split out because scheduling.ts imports lib/supabase, and ScheduleAlerts is
 * a client component that needs LATE_OPTIONS and lateLabel. Importing them
 * from there put the service-role Supabase client one import away from the
 * browser and shipped supabase-js in the bundle.
 *
