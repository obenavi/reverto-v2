...
const CAT_RULES = {
  ...
  drinks:   /יין|בירה|וודק|ויסק|קוניאק|ליקר|ערק|רום|ג'ין|טקילה|שמפני|פרוסקו|מיץ|נקטר|לימונדה|קולה|סודה|משקה קל|מים מינרלי|מי עדן|תוסס|אנרג'י|רד בול|בקבוק יין|פחית משקה/,
