...
const CAT_RULES = {
  ...
  // "סירופ" lives here, not in packaged — bar/soda flavoring syrups (e.g. "סירופ
  // אבטיח") are a drinks-supplier staple, and drinks is checked before produce so
  // it correctly wins over the fruit name the syrup happens to be flavored with.
  drinks:   /יין|בירה|וודק|ויסק|קוניאק|ליקר|ערק|רום|ג'ין|טקילה|שמפני|פרוסקו|מיץ|נקטר(?!ינה)|לימונדה|קולה|סודה|משקה קל|מים מינרלי|מי עדן|תוסס|אנרג'י|רד בול|בקבוק יין|פחית משקה|סירופ/,
  ...
  packaged: /שמן|קמח|סוכר|מלח|אורז|פסטה|עדש|שעורה|כוסמת|קינואה|רוטב|קטשופ|חרדל|מיונז|אכסוס|שמר|אבקה|שוקולד|קפה|תה|קרקר|לחם|לחמניה|פיתה|בגט|טורטי|נאן|עוגי|ביסקוי|ריבה|דבש|שוקו|ממרח|חומוס|טחינ|צנים|פיצוח|ממתק|שימור|קופסא|בצק|קינוח/,
